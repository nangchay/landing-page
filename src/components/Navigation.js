            ...
            <div data-aos="fade-down" id='main' className='w-full bg-[#fff] h-[100px] z-[120] flex relative cf:mt-[33px] mb-0'>
                ...
                <div className='px-4 sm:px-12 xl:px-48 flex justify-between items-center w-full h-full z-[120]'>
                    <div className='flex items-center z-[117]'>
                        <div className={`lg:ml-4 w-[78px] h-[62.156px] shrink-0 bg-[url(/src/assets/images/logo.png)] bg-cover bg-no-repeat rounded-[13px] relative z-[120]`} />
                        <div className="shrink-0 font-['SVN-Averia_Serif_Libre'] text-[20px] font-bold leading-[25.547px] relative text-left whitespace-nowrap z-[120]">
                            ...
                            <span className={`font-['SVN-Averia_Serif_Libre'] 16px font-normal leading-[25.547px] text-[#707070] relative text-left z-[120]`}>
                    ...
                    <div className='hidden xl:flex z[120]'>
                        ...
                        <ul className='hidden text-[#323232] xl:flex z-[120]'>
                            <li>
                                <a href="#main" onClick={(e) => smoothScroll(e, 'main')} className={`h-[30px] shrink-0 basis-auto font-['SVN-Averia_Serif_Libre'] text-[24px] font-bold leading-[30px] relative text-left whitespace-nowrap z-[27] ${activeTab === 'main' ? 'text-[#6b8439]' : 'text-[#707070]'} hover:text-[#6b8439]`}>
                                    Main
                            ...
                            <li>
                                <a href="#about" onClick={(e) => smoothScroll(e, 'about')} className={`h-[30px] shrink-0 basis-auto font-['SVN-Averia_Serif_Libre'] text-[24px] font-normal leading-[30px] relative text-left whitespace-nowrap z-[29] ${activeTab === 'about' ? 'text-[#6b8439]' : 'text-[#707070]'} hover:text-[#6b8439]`}>
                                    About
                            ...
                            <li>
                                <a href="#value" onClick={(e) => smoothScroll(e, 'value')} className={`h-[30px] shrink-0 basis-auto font-['SVN-Averia_Serif_Libre'] text-[24px] font-normal leading-[30px] relative text-left whitespace-nowrap z-[31] ${activeTab === 'value' ? 'text-[#6b8439]' : 'text-[#707070]'} hover:text-[#6b8439]`}>
                                    Value
                            ...
                            <li>
                                <a href="#faqs" onClick={(e) => smoothScroll(e, 'faqs')} className={`h-[30px] shrink-0 basis-auto font-['SVN-Averia_Serif_Libre'] text-[24px] font-normal leading-[30px] relative text-left whitespace-nowrap z-[33] ${activeTab === 'faqs' ? 'text-[#6b8439]' : 'text-[#707070]'} hover:text-[#6b8439]`}>
                                    FAQs
