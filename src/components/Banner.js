...
function Banner() {
    ...
    return (
        <div id="main" className="bg-[url(https://res.cloudinary.com/nangchay/image/upload/v1720423404/nangchay/bg_banner.jpeg)] bg-center bg-cover bg-no-repeat flex flex-col-reverse md:flex-row w-screen gap-0 items-center flex-nowrap relative z-[1] pb-8 pt-36">

            <div data-aos="fade-in" className='px-6 xl:px-48 flex w-full md:w-3/5 h-full flex-col gap-[12px] md:gap-[36px] justify-center place-items-center md:place-items-start relative z-[2]'>
            ...
            <div className='flex gap-[10px] items-center grow basis-0 flex-nowrap relative z-[7]'>
                <div data-aos="zoom-in" className='w-[300px] h-[200px] md:h-[360px] md:w-[262px] lg:h-[420px] lg:w-[306px] xl:h-[420px] xl:w-[306px] cf:h-[486px] cf:w-[354px] bg-[url(https://res.cloudinary.com/nangchay/image/upload/v1720423404/nangchay/banner_mobile.jpg)] md:bg-[url(https://res.cloudinary.com/nangchay/image/upload/v1720423404/nangchay/banner.jpg)] bg-cover bg-no-repeat bg-center rounded-[12px] border-solid border border-[#323232] relative z-[8]' />
                <div data-aos="flip-left" data-aos-easing="ease-out-cubic" data-aos-duration="2000" className='flex w-[88px] flex-col gap-[10px] items-center flex-nowrap relative z-[9]'>
                    ...
                    <div className='w-px h-[40px] shrink-0 bg-[url(https://res.cloudinary.com/nangchay/image/upload/v1720423404/nangchay/social_line.png)] bg-cover bg-no-repeat relative z-[11]' />
                    <a href="https://www.instagram.com/nangchayvn" target="_blank" rel="noopener noreferrer" className='w-[24px] h-[24px] inline-block transform transition-transform duration-300 hover:translate-x-2'>
                        <div className='w-[24px] h-[24px] shrink-0 relative overflow-hidden z-[12]'>
                            <div className='w-[20.001px] h-[20px] bg-[url(https://res.cloudinary.com/nangchay/image/upload/v1720423404/nangchay/social_insta.png)] bg-[length:100%_100%] bg-no-repeat relative z-[13] mt-[2px] mr-0 mb-0 ml-[1.999px]' />
                        </div>
                    </a>
                    <a href="https://www.facebook.com/nangchayvn" target="_blank" rel="noopener noreferrer" className='w-[24px] h-[24px] inline-block transform transition-transform duration-300 hover:translate-x-2'>
                        <div className='w-[24px] h-[24px] shrink-0 relative overflow-hidden z-[14]'>
                            <div className='w-[20px] h-[19.95px] bg-[url(https://res.cloudinary.com/nangchay/image/upload/v1720423404/nangchay/social_fb.png)] bg-[length:100%_100%] bg-no-repeat relative z-[15] mt-[2px] mr-0 mb-0 ml-[2px]' />
                        </div>
                    </a>
                    <a href="https://www.tiktok.com/@nangchayvn" target="_blank" rel="noopener noreferrer" className='w-[24px] h-[24px] inline-block transform transition-transform duration-300 hover:translate-x-2'>
                        <div className='w-[24px] h-[24px] shrink-0 relative overflow-hidden z-[16]'>
                            <div className='w-[15.68px] h-[18px] bg-[url(https://res.cloudinary.com/nangchay/image/upload/v1720423404/nangchay/social_tiktok.png)] bg-[length:100%_100%] bg-no-repeat relative z-[17] mt-[3px] mr-0 mb-0 ml-[4.16px]' />
                        </div>
                    </a>
                </div>
            </div>
