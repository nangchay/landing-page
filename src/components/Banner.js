...
function Banner() {
    ...
    return (
        <div id="main" className="bg-[url(/src/assets/images/bg-banner.jpeg)] bg-center bg-cover bg-no-repeat flex flex-col-reverse md:flex-row w-screen gap-0 items-center flex-nowrap relative z-[1] pb-8 pt-36">
